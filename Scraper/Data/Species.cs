			...
			return new Dictionary<string, C.Species>()
				{
					...
					{"El", new C.Species("Elf", "El","0.1.0","2.7.0", false)},
					{"HE", new C.Species("High Elf", "HE")},
					{"GE", new C.Species("Grey Elf", "GE","0.1.0","4.5.0", false)},
					{"DE", new C.Species("Deep Elf", "DE")},
					{"SE", new C.Species("Sludge Elf", "SE","0.1.0","0.12.2", false)},
					{"HD", new C.Species("Hill Dwarf", "HD","0.1.0","2.7.0", false)},
					...
					{"Gn", new C.Species("Gnome", "Gn","0.1.0","4.5.0", false)},
					{"Ce", new C.Species("Centaur", "Ce")},
					{"Og", new C.Species("Ogre", "Og")},
					{"OM", new C.Species("Ogre-Mage", "OM","0.1.0","4.5.0", false)},
